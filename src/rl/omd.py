# AUTOGENERATED! DO NOT EDIT! File to edit: ../../04_decision-focused-comparison.ipynb.

# %% auto 0
__all__ = ['SimpleReplay', 'soft_bellman_model_expected', 'soft_bellman_buffer_target', 'update_q_step_differentiable',
           'update_q_table_ema', 'update_theta_vjp', 'update_q_table_inplace_for_acting', 'soft_value_iteration',
           'fit_empirical_model_from_replay', 'compute_soft_policy_from_model', 'evaluate_policy', 'per_state_kl',
           'train_omd_env_once', 'batch_run']

# %% ../../04_decision-focused-comparison.ipynb 3
class SimpleReplay:
...
# %% ../../04_decision-focused-comparison.ipynb 4
...
# --------------------------
# soft value iteration and evaluation helpers
# --------------------------
...
# --------------------------
# Single-run train function (OMD) acting on a gymnasium env
# --------------------------
def train_omd_env_once(
    env,
    seed,
    max_iterations=1200,
    K=4,
    ...
    # produce learned model and replay
...
# --------------------------
# Batch loop: run seeds, collect metrics into DataFrame
# --------------------------
def batch_run(
    ...
    for i in range(n_seeds):
        seed = 1000 + i  # or any sequence
        # create env per-seed for reproducibility
        env = gym.make(env_name, map_name=map_name, is_slippery=is_slippery)
        learned_P, learned_R, replay = train_omd_env_once(
...
# --------------------------
# If run as script, execute batch and save CSV
# --------------------------
if __name__ == "__main__":
    ...
    print("\nSUMMARY")
    print(df.describe())
    df.to_csv("omd_vs_empirical_frozenlake.csv", index=False)
    print("Saved results to omd_vs_empirical_frozenlake.csv")
